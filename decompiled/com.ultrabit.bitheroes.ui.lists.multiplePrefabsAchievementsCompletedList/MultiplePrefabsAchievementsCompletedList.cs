...
public class MultiplePrefabsAchievementsCompletedList : OSA<MyParams, BaseVH>
{
	...
	public BaseVH AchievementCompletedTileVH { get; private set; }
	...
	protected override BaseVH CreateViewsHolder(int itemIndex)
	{
		...
		if (cachedType == typeof(AchievementCompletedTileModel))
		{
			AchievementCompletedTileVH achievementCompletedTileVH = new AchievementCompletedTileVH();
			achievementCompletedTileVH.Init(_Params.AchievementCompletedTile, _Params.Content, itemIndex);
			return achievementCompletedTileVH;
		}
	...
	protected override void UpdateViewsHolder(BaseVH newOrRecycled)
	{
		...
		if (newOrRecycled is AchievementCompletedTileVH achievementCompletedTileVH)
		{
			achievementCompletedTileVH.UpdateACTViews(model, trophyHandler);
		}
		else
		{
