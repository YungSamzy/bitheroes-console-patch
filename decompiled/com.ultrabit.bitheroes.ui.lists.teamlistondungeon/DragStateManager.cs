...
{
	public MyListItemViewsHolder Dragged { get; private set; }

	public DungeonEntityTileModel ModelOfDragged { get; private set; }
	...
	public void EnterState_PreparingForDrag(MyListItemViewsHolder dragged, DungeonEntityTileModel modelOfDragged, EmptyModel placeholderModel)
	{
		Dragged = dragged;
